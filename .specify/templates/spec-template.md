...
- **[Command/API Name]**: [Describe text-based request/response contract, including arguments, formats, and exit codes]
- **Inputs**: [stdin args / payload schema]
- **Outputs**: [stdout format, error channels, logging expectations]
- **Contracts Folder Link**: `specs/[###-feature]/contracts/[name].md`
